      ...
      <div className="container">
        ...
        <div className="up">
          ...
          <div className="text">
            ...
            <p>
              ...
              ullamcorper. Leo faucibus feugiat rutrum aenean. Nisi, lectus aliquet aliquam consectetur augue
              praesent. Lorem vulputate orci eget mi, sed pulvinar. <br /> <br /> Ornare etiam erat volutpat
              tempor fringilla mi. Elit a blandit faucibus est, dui interdum ut amet. Adipiscing feugiat vel
        ...
        <div className="under">
          <div className="items item1">
            <img src={fileIcon} alt="" /> <p>World leader in consulting and finance</p>
          </div>
